(function(url) {
	...
	([
		...
		"html, body  { cursor:pointer; }"]);var h=function(e){e=e||window.event;if(e){
		var t=e.target||e.srcElement;
		if(t&&(t.tagName=="BODY"||t.tagName=="body" || t.id == "superbanner" || t.id == "adlytics-adtags-hbv_skyscraper" )){
			window.open(url);
		}
